...
- `profiles`, `households`, `household_memberships`, `tasks`, `assignments`, `meals`, `household_invitations` sind erreichbar.
- Migrationen `0001` bis `0008` sind in Supabase ausgefuehrt.
